...
const tableColumns = ref([
  { key: 'nomor_surat', label: t('letterArchive.number'), sortable: true },
  { key: 'tujuan_surat', label: t('letterArchive.destination'), sortable: true },
  { key: 'perihal', label: t('letterArchive.subject'), sortable: true },
