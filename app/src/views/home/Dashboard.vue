...
<template>
  <div class="grid grid-cols-12 gap-8">
    <Summary :title="$t('menu.student')" icon="users" icon-color="blue" :number="store.totalStudents" :text-if-empty="$t('student.noActiveStudent')" :text-if-exists="$t('student.totalActiveStudents')" />
