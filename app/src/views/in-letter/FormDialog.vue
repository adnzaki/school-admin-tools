  ...
  <Dialog :header="store.formTitle" v-model:visible="store.showForm" @show="onDialogShow" @hide="onDialogHide" :breakpoints="{ '960px': '75vw' }" :style="{ width: '30vw' }" :modal="true">
    <div class="flex flex-col gap-4">
      ...
      <div class="flex flex-col gap-2">
        ...
        <FileUpload ref="fileUpload" name="upload[]" :show-upload-button="false" :show-cancel-button="false" :file-limit="1" auto @uploader="onUpload" accept=".pdf,application/pdf,image/*" :maxFileSize="4000000" customUpload />
      </div>
    </div>
    <template #footer>
